...
function update () {
    ...
    document.querySelector("#translated").innerHTML = translated;
        responsiveVoice.speak(translated);
    
}

/*
console.log(document.querySelector('translated'))
console.log(document.querySelector("#translated").innerHTML)
*/
function addLetter () {
